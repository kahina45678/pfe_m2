    ...
    try {
      ...
      socket.on('connect', () => {
        ...
        socket.on('room_created', (data) => {
          navigate(`/quiz/${roomData.room_code}`);
        });
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-xl shadow-md overflow-hidden p-8 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-red-100 p-6 rounded-lg"> {/* Rouge clair */}
            <h3 className="text-xl font-semibold text-red-800 mb-4 flex items-center"> {/* Rouge foncé */}
